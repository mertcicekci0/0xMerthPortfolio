...
export default function Hero() {
    return (
        <section className="min-h-screen flex flex-col justify-center px-6 md:px-12 pt-32 pb-12 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
                ...
                <div className="hidden md:flex flex-col justify-center items-center h-full">
                    <motion.div
                        ...
                        className="bg-neutral-50 border border-black/10 p-6 font-mono text-xs text-neutral-800 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] transition-all duration-300 min-w-[340px] scale-110 origin-center"
                    >
